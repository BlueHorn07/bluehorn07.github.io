...
# [Calculus]({{"/categories/calculus" | relative_url}})

고등학교부터 AP 수업으로 공부했던 과목입니다. 대학에서 배우는 모든 수학의 기초가 되는 과목으로 꾸준히 복습해야 하는 것 같습니다 🚀

<hr/>

# [Linear Algebra]({{"/categories/linear-algebra" | relative_url}})

행렬의 성질과 간단한 응용들을 배웠습니다. 많은 수식과 이론이 행렬 형태로 표현 되기에 공대생의 기초라고 생각합니다 🏫

<hr/>

# [Differential Equations]({{"/categories/differential-equations" | relative_url}})
