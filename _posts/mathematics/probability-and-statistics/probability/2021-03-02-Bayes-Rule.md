...
<img src="/images/mathematics/probability-and-statistics/event-partition.png" style="width:200px;">
</div>
...
1. 코로나에 걸린 사람이 양성으로 나올 확률 $P(+ \mid C)$은 $0.95$
2. 코로나에 걸리지 않은 사람이 양성으로 나올 확률은 $P(+ \mid \sim C)$은 $0.01$
...
<div class="img-wrapper">
<img src= "/images/mathematics/probability-and-statistics/bayes-rule-1.png" width="100%">
</div>
...
<div class="img-wrapper">
<img src= "/images/mathematics/probability-and-statistics/bayes-rule-2.png" width="100%">
</div>
...
\<베이즈 주의자\>라는 게 사실은 그리 대단한 존재들이 아니다. **관찰된 사실을 바탕으로 본인의 믿을을 갱신하는 사람**이라면 모두가 \<베이즈 주의자\>이다! ~~베이즈 주의자 만세!~~
